...
关于排版，相信大家即使没实际接触过，也听说过。

> 排版，是指将文字、图片、图形等可视化信息元素在版面布局上调整位置、大小，是使版面布局条理化的过程。按照稿本把铅字、图版等排在一起拼成书报的版子，以供印刷。
> ——百度百科


当我们的语言整齐，规范，措辞准确时，语言看起来会专业。所以，你需要有基础的语文知识，相信大家都上过语文课。

GitHub 上已经有了一份广泛认可的排版指引，[点击跳转](https://github.com/sparanoid/chinese-copywriting-guidelines)。  
由于部分人网络原因无法流畅访问 GitHub，我将这篇指引写进本文章中，并做适当修改。
...
本次不布置上交作业，各位在日常交流中请尽可能按照此指引发言，这会使你的语言更加规范。
